...
@php
    ...
    $categories = IncomeCategory::where('is_system', true)
...
<div class="p-4">
    <h1 class="text-2xl font-bold text-center mb-6">{{ __('common.income_entries') }}</h1>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3" id="categoriesGrid">
        @foreach($categories as $category)
            <a 
                href="{{ route('mobile.income.create', $category->id) }}" 
